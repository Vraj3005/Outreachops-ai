...
from app.services.error_service import MissingCredentialsError, GoogleSheetTabError
...
class SheetsService:
    ...
    """
    def __init__(self):
        self.creds_path = (os.getenv("GOOGLE_SHEETS_CREDENTIALS_PATH") or settings.SHEETS_CREDENTIALS_PATH).strip()
    ...
    def import_leads(self, user_id: str) -> Dict[str, Any]:
        ...
        if settings.DEMO_MODE:
            ...
            if not supabase:
                return {"imported": 0, "skipped_duplicates": 0, "total_processed": 0, "error": "Database client offline"}
        ...
        try:
            ...
            raise GoogleSheetTabError(message="Failed to read spreadsheet data", details={"error": str(e)})
        ...
        if not supabase:
            ...
            return {"imported": 0, "skipped_duplicates": 0, "total": 0, "error": "Database client offline"}
